...
<div class="admin-wrapper">
    <aside class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?= BASE_URL ?>/admin/categories.php" class="active">
    ...
    <main class="admin-main">
        <!-- <div class="admin-header">
            ...
            <div class="admin-nav">
                <a class="btn btn-light" href="<?= BASE_URL ?>/admin/product_types.php">Loại SP</a>
                ...
                <a class="btn btn-back" href="<?= BASE_URL ?>/admin/products.php">← Quay lại kho SP</a>
            </div>
        </div> -->
        ...
        <div class="alert info">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="flex-shrink: 0;"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>
            <div>Hệ thống đang dùng cấu trúc phân loại 2 tầng. <strong>Ví dụ:</strong> "Áo" là Danh mục chính, còn "Áo Khoác", "Áo Polo" sẽ là Loại sản phẩm thuộc danh mục "Áo".</div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="admin-table">
                        ...
                        <?php if (empty($categories)): ?>
                            <tr>
                                <td colspan="4" style="text-align: center; padding: 40px 20px; color: var(--admin-text-muted);">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom: 12px; color: #9ca3af;"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
                                    <br>Chưa có danh mục nào. Hãy thêm mới ở form bên cạnh!
                                </td>
                            </tr>
                        <?php endif; ?>
                        ...
                        <?php foreach ($categories as $cat): ?>
                            <tr>
                                <td><strong style="font-weight: 600;"><?= e($cat['name']) ?></strong></td>
                                <td style="color: var(--admin-text-muted); font-size: 13px; font-family: monospace;"><?= e($cat['slug'] ?? '') ?></td>
                                ...
                                <td>
                                    <a class="btn-delete" 
                                       ...
                                       href="<?= BASE_URL ?>/admin/categories.php?delete=<?= (int)$cat['id'] ?>">
                                       Xóa
                                    </a>
                                </td>
                            </tr>
