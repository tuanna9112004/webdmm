...
/* Tùy chỉnh icon mũi tên cho select box */
select.form-control {
...
<div class="admin-wrapper">
    <aside class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?= BASE_URL ?>/admin/product_types.php" class="active">
        ...
        <div class="category-layout">
            <div class="admin-card">
                <form method="post" action="">
                    ...
                    <div class="form-group">
                        <label>Tên loại sản phẩm <span class="required-mark">*</span></label>
                        <input type="text" name="name" class="form-control" required placeholder="VD: Áo Khoác, Sơ Mi, Quần Jean...">
                    </div>
                            ...
                            <tr>
                                <td>
                                    <span class="badge-category-parent">
                                        ...
                                        <?= e($type['category_name']) ?>
                                    </span>
                                </td>
                                <td><strong style="font-weight: 600;"><?= e($type['name']) ?></strong></td>
                                <td style="color: var(--admin-text-muted); font-size: 13px; font-family: monospace;"><?= e($type['slug'] ?? '') ?></td>
                                ...
                                <td>
                                    <a class="btn-delete" 
                                       onclick="return confirm('Bạn có chắc chắn xóa loại sản phẩm này?');" 
                                       href="<?= BASE_URL ?>/admin/product_types.php?delete=<?= (int)$type['id'] ?>">
                                       Xóa
                                    </a>
                                </td>
                            </tr>
