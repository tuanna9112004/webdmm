...
<div class="admin-wrapper">
    <aside class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="<?= BASE_URL ?>/admin/styles.php" class="active">
                ...
                <div class="table-responsive">
                    <table class="admin-table">
                        ...
                        <?php if (empty($styles)): ?>
                            <tr>
                                <td colspan="4" style="text-align: center; padding: 40px 20px; color: var(--admin-text-muted);">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="margin-bottom: 12px; color: #9ca3af;"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                                    <br>Chưa có phong cách nào. Hãy thêm mới ở form bên cạnh!
                                </td>
                            </tr>
                        <?php endif; ?>
                        ...
                        <?php foreach ($styles as $style): ?>
                            <tr>
                                <td><strong style="font-weight: 600;"><?= e($style['name']) ?></strong></td>
                                <td style="color: var(--admin-text-muted); font-size: 13px; font-family: monospace;"><?= e($style['slug'] ?? '') ?></td>
                                <td style="text-align: center;">
                                    <span style="background: #f3f4f6; padding: 4px 8px; border-radius: 6px; font-size: 12px; font-weight: 600; color: #4b5563;">
                                        <?= (int)$style['sort_order'] ?>
                                    </span>
                                </td>
                                <td>
                                    <a class="btn-delete" 
                                       onclick="return confirm('Bạn có chắc chắn xóa phong cách này?');" 
                                       href="<?= BASE_URL ?>/admin/styles.php?delete=<?= (int)$style['id'] ?>">
                                       Xóa
                                    </a>
                                </td>
                            </tr>
